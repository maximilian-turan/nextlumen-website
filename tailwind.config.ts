  ...
  theme: {
    extend: {
      colors: {
        ...
        primary: {
          DEFAULT: "#6366F1", // Indigo for trust/professionalism
          hover: "#4F46E5", // Darker indigo on hover
          light: "#818CF8", // Lighter indigo for accents
        },
        accent: {
          DEFAULT: "#00D4FF", // Cyan for AI/tech accent
          hover: "#00B8E6", // Darker cyan on hover
          light: "#33E0FF", // Lighter cyan
        },
        border: {
